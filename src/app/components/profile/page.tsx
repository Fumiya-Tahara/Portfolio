  ...
  return (
    <div className="bg-gray-300 py-12 lg:py-24 min-h-screen">
      ...
      <div className="flex justify-center">
        <div className="w-2/3 px-4 py-4 bg-white rounded-lg flex justify-center items-center" style={{"aspectRatio": 1.618 / 1}}>
          <div className="flex flex-col lg:flex-row justify-center pb-20 lg:w-2/3">
            <div>
              <a href="https://github.com/Fumiya-Tahara" className="flex justify-center">
